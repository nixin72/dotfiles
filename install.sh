...
sudo cp -r ~/configs/backgrounds/* /usr/share/backgrounds/
...
sudo cp ~/configs/sources/FiraCode-Retina.otf ~/.local/share/fonts/FiraCode-Retina.otf
sudo cp ~/configs/sources/FiraCode-Retina.otf /usr/share/terminology/fonts/FiraCode-Retina.otf
sudo cp ~/configs/sources/FiraCode-Retina.otf /usr/share/terminology/fonts/FiraCode-Retina.otf
