...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(treemacs parinfer button-lock fixmee fzf)
...
you should place your code here."
 ...
 (use-package treemacs
  ...
  (spacemacs/set-leader-keys "f t" 'treemacs)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(fzf fixmee string-utils back-button button-lock ucs-utils smartrep nav-flash persistent-soft pcache list-utils clojure-snippets clj-refactor inflections cider-eval-sexp-fu parinfer paredit zones cider yaml-mode phpunit phpcbf php-extras php-auto-yasnippets drupal-mode php-mode unfill smeargle orgit mwim magit-gitflow magit-popup helm-gitignore helm-company helm-c-yasnippet gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link fuzzy evil-magit magit company-web web-completion-data company-statistics company-shell company-emacs-eclim company-c-headers company-anaconda common-lisp-snippets auto-yasnippet ac-ispell auto-complete yapfify web-mode web-beautify wakatime-mode toml-mode tide typescript-mode tagedit sql-indent slime-company company slime slim-mode scss-mode sass-mode racket-mode faceup racer pyvenv pytest pyenv-mode py-isort pug-mode pip-requirements livid-mode skewer-mode simple-httpd live-py-mode json-mode json-snatcher json-reformat js2-refactor multiple-cursors js2-mode js-doc insert-shebang hy-mode dash-functional helm-pydoc helm-css-scss haml-mode geiser flycheck-rust fish-mode emmet-mode eclim yasnippet disaster cython-mode coffee-mode clang-format cargo rust-mode anaconda-mode pythonic cmake-mode treemacs org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-mime org-download mmm-mode markdown-toc markdown-mode htmlize gnuplot git-gutter-fringe+ git-gutter-fringe fringe-helper git-gutter+ git-commit with-editor transient git-gutter gh-md flyspell-correct-helm flyspell-correct flycheck-pos-tip pos-tip flycheck diff-hl auto-dictionary ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint indent-guide hydra lv hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-projectile projectile pkg-info epl helm-mode-manager helm-make helm-flx helm-descbinds helm-ag google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired f evil-tutor evil-surround evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu elisp-slime-nav dumb-jump dash s diminish define-word column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core popup async)))
(custom-set-faces
